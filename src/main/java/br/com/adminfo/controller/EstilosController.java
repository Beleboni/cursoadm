...
public class EstilosController {
	...
	@GetMapping
	public ModelAndView pesquisar(EstiloFilter clienteFilter, @PageableDefault(size = 2) Pageable pageable, HttpServletRequest httpServletRequest) {
		ModelAndView mv = new ModelAndView("estilo/PesquisaEstilos");
		
		PageWrapper<Estilo> paginaWrapper = new PageWrapper<>(estilos.filtrar(clienteFilter, pageable), httpServletRequest);
